...
const secondLevelMenus = {
  ...
  budget: [
    ...
    },
    {
      ...
      label: '预计完成数',
      children: [
        { key: '/budget/planned-complete-region', label: '费用制片区' },
        { key: '/budget/planned-complete-general-agent', label: '总代' },
        { key: '/budget/planned-complete-agent-region', label: '代理制片区' },
...
const pageTitleMap = {
  ...
  '/budget/planned-complete-region': '预计完成数-费用制片区',
  '/budget/planned-complete-general-agent': '预计完成数-总代',
  '/budget/planned-complete-agent-region': '预计完成数-代理制片区',
  '/budget/planned-complete-hq': '预计完成数-总部直营',
  '/budget/planned-complete-digital': '预计完成数-数字营销&城市连锁',

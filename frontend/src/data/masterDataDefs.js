...
export const MASTER_DATA_DEFS = {
  ...
  'md-customer': {
    ...
    columns: [
      ...
      { dataIndex: 'data_match_type', title: '数据匹配类型', key: 'data_match_type' },
      { dataIndex: 'is_active_customer', title: '活跃客户标识', key: 'is_active_customer', inputType: 'select', options: [
        { label: '是', value: 1 },
        { label: '否', value: 0 },
      ]},
      { dataIndex: 'is_valid', title: '是否有效', key: 'is_valid', inputType: 'select', options: [
...
export const MAPPING_TABLE_DEFS = {
  ...
  'map-virtual-product': {
    ...
    columns: [
      ...
      { dataIndex: 'product_code', title: '产品编码', key: 'product_code' },
      { dataIndex: 'product_name', title: '产品名称', key: 'product_name' },
      { dataIndex: 'created_at', title: '创建时间', key: 'created_at' },
      { dataIndex: 'created_by', title: '创建人', key: 'created_by' },
      { dataIndex: 'updated_at', title: '最后更新时间', key: 'updated_at' },
      { dataIndex: 'updated_by', title: '最后更新人', key: 'updated_by' },
      { dataIndex: 'is_valid', title: '是否有效', key: 'is_valid', inputType: 'select', options: [
        { label: '是', value: 1 },
        { label: '否', value: 0 },
      ]},

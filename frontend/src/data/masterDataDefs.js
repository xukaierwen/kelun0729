...
export const MAPPING_TABLE_DEFS = {
  ...
  'map-analysis-convert-factor': {
    ...
    columns: [
      ...
      { dataIndex: 'product_name', title: '产品名称', key: 'product_name', rules: [{ required: true }] },
      { dataIndex: 'month_1', title: '1月', key: 'month_1' },
      { dataIndex: 'month_2', title: '2月', key: 'month_2' },
      { dataIndex: 'month_3', title: '3月', key: 'month_3' },
      { dataIndex: 'month_4', title: '4月', key: 'month_4' },
      { dataIndex: 'month_5', title: '5月', key: 'month_5' },
      { dataIndex: 'month_6', title: '6月', key: 'month_6' },
      { dataIndex: 'month_7', title: '7月', key: 'month_7' },
      { dataIndex: 'month_8', title: '8月', key: 'month_8' },
      { dataIndex: 'month_9', title: '9月', key: 'month_9' },
      { dataIndex: 'month_10', title: '10月', key: 'month_10' },
      { dataIndex: 'month_11', title: '11月', key: 'month_11' },
      { dataIndex: 'month_12', title: '12月', key: 'month_12' },
      { dataIndex: 'created_at', title: '创建时间', key: 'created_at', inputType: 'date' },
      { dataIndex: 'is_valid', title: '是否有效', key: 'is_valid', inputType: 'switch', options: [
        { label: '是', value: 1 },
        { label: '否', value: 0 },
